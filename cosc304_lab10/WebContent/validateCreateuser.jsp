...
<%
	...
	try
	{
		authenticatedUser = validateCreateuser(out,request,session);
	}
	catch(IOException e)
...
<%!
	String validateCreateuser(JspWriter out,HttpServletRequest request, HttpSession session) throws IOException
	{
